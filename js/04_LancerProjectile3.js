...
const nbrSegmentParCbe = 50;//nbre de segment par courbe de Bezier
const nb=200;//nmbre de pts par courbe
const epai=4;//epaisseur de la courbe sur la balle de tennis
const dimPt=0.05;
const nbPtTennis = 2000;
let PtCourant=0;
